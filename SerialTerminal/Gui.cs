using System;
	public static class Gui
	{
		...
		public static Gtk.Adjustment AdjustSerialLookTime;
		public static Gtk.Dialog DialogConfigApp;
		public static Gtk.VBox vbox8;
		public static Gtk.Label label188;
		public static Gtk.FontButton FontButtonConsola;
		public static Gtk.Label label189;
		public static Gtk.FontButton FontButtonProgram;
		public static Gtk.Table table1;
		public static Gtk.Label label1;
		public static Gtk.SpinButton SpinBtnSerialLookTime;
		public static Gtk.Label label2;
		public static Gtk.CheckButton ChkStrictTimeStamp;
		public static Gtk.Label label3;
		public static Gtk.CheckButton ChkbtPrintTimeStamp;
		public static Gtk.Label label4;
		public static Gtk.CheckButton ChkbtPrintCrLfs;
		public static Gtk.Label label5;
		public static Gtk.CheckButton ChkbtnUseIdleTimer;
		public static Gtk.Button BtOk;
		public static Gtk.Button BtCancelar;
		...
		public static Gtk.ToolButton ToolButtonConfigurar;
		...
		public static Gtk.HBox HbSearchBox;
		public static Gtk.Entry EntrySearchBox;
		public static Gtk.Button BtSearchBackward;
		public static Gtk.Button BtSearchForward;
		public static Gtk.Button BtHideSearchBox;
		...
		public static void InitObjects(string gtkb){
			...
			AdjustSerialLookTime=(Gtk.Adjustment)gbuild.GetObject("AdjustSerialLookTime");
			DialogConfigApp=(Gtk.Dialog)gbuild.GetObject("DialogConfigApp");
			vbox8=(Gtk.VBox)gbuild.GetObject("vbox8");
			label188=(Gtk.Label)gbuild.GetObject("label188");
			FontButtonConsola=(Gtk.FontButton)gbuild.GetObject("FontButtonConsola");
			label189=(Gtk.Label)gbuild.GetObject("label189");
			FontButtonProgram=(Gtk.FontButton)gbuild.GetObject("FontButtonProgram");
			table1=(Gtk.Table)gbuild.GetObject("table1");
			label1=(Gtk.Label)gbuild.GetObject("label1");
			SpinBtnSerialLookTime=(Gtk.SpinButton)gbuild.GetObject("SpinBtnSerialLookTime");
			label2=(Gtk.Label)gbuild.GetObject("label2");
			ChkStrictTimeStamp=(Gtk.CheckButton)gbuild.GetObject("ChkStrictTimeStamp");
			label3=(Gtk.Label)gbuild.GetObject("label3");
			ChkbtPrintTimeStamp=(Gtk.CheckButton)gbuild.GetObject("ChkbtPrintTimeStamp");
			label4=(Gtk.Label)gbuild.GetObject("label4");
			ChkbtPrintCrLfs=(Gtk.CheckButton)gbuild.GetObject("ChkbtPrintCrLfs");
			label5=(Gtk.Label)gbuild.GetObject("label5");
			ChkbtnUseIdleTimer=(Gtk.CheckButton)gbuild.GetObject("ChkbtnUseIdleTimer");
			BtOk=(Gtk.Button)gbuild.GetObject("BtOk");
			BtCancelar=(Gtk.Button)gbuild.GetObject("BtCancelar");
			...
			ToolButtonConfigurar=(Gtk.ToolButton)gbuild.GetObject("ToolButtonConfigurar");
			...
			HbSearchBox=(Gtk.HBox)gbuild.GetObject("HbSearchBox");
			EntrySearchBox=(Gtk.Entry)gbuild.GetObject("EntrySearchBox");
			BtSearchBackward=(Gtk.Button)gbuild.GetObject("BtSearchBackward");
			BtSearchForward=(Gtk.Button)gbuild.GetObject("BtSearchForward");
			BtHideSearchBox=(Gtk.Button)gbuild.GetObject("BtHideSearchBox");
